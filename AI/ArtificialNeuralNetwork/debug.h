...
//#define BUILD_DEBUG
	...
	#define INFO_ENABLE false
	#define ERROR_ENABLE true
	#define WARNING_ENABLE false
	#define APPEND_ENABLE false
...
#if INFO_ENABLE
	#define INFO(msg) cout<<__PRETTY_FUNCTION__<<" - INFO, "<<msg
#else
...
#define VERSION_STRING "Introduction to AI - Project2\n"\
